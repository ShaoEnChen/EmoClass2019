...
# Select preprocess
print('Selecting preprocess method')
## TODO:

train_set = FER2013(read_data(train_file), transform=None)
split_trainset = shrink_data((train_set,200)
transform_train = gridsearch (split_trainset)
